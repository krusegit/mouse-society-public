...
/** @type {string} */
const CACHE_VERSION = '1790023521|1284621';
/** @type {string} */
const CACHE_PREFIX = 'Mouse Society-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libmouse_society.web.template_release.wasm32.wasm"];
